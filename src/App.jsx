      ...
      <section className="text-gray-700 border-t border-gray-200">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="pb-10 ">
              これまで生産管理・総務・営業事務と、現場に根ざした多様な業務に携わってきました。生産管理時代はフィリピン工場との生産計画～納品まで一度も遅延を起こさず臨機応変な判断で業務を遂行しました。
	総務では、立ち上げ直後の部署で社員の要望にはなんでも応えられるよう努め、新入社員研修・備品管理・労務対応・社内インフラ改善など幅広い業務を担当。有給申請のWebシステム導入など、現場の課題をシステム改善に結びつける提案も行いました。
営業事務では手書きのフォーマットからExcelでの自動化に取り組み、常に「現場の困った」に目を向け、自ら動くスタイルで業務改善をリードしてきました。
「なんとかしてみせる」が私のスタンス。どの職種でも、枠にとらわれず、自分の役割を超えて動いてきた経験が今の糧になっています。
            </p>
            <p>
...
>
  <g fill="#4B4B4B">
    <path d="M232.772,7.381H0.08V226.57h96.57C175.346,198.394,232.772,110.966,232.772,7.381z" />
    <path d="M152.422,361.618c-7.152-40.299-27.213-63.222-55.862-96.369H0v118.667
      c8.996-20.462,29.458-34.782,53.192-34.782c28.64,0,52.582,20.879,57.072,48.284h21.087
      C133.597,382.897,141.374,370.413,152.422,361.618z" />
    <path d="M279.316,7.381c0,103.585,57.426,191.013,136.114,219.189H512V7.381H279.316z" />
    <path d="M458.912,349.134c23.533,0,43.995,14.128,52.999,34.381V265.249h-96.577
      c-28.439,33.146-48.493,56.07-55.645,96.369c11.041,8.796,18.818,21.28,21.071,35.8h21.063
      C406.33,370.013,430.272,349.134,458.912,349.134z" />
    <path d="M70.839,439.625c11.682-6.319,19.708-18.522,19.708-32.73c0-20.662-16.742-37.363-37.372-37.363
      c-20.63,0-37.364,16.701-37.364,37.363c0,14.208,8.018,26.412,19.692,32.73c-20.59,7.296-35.424,26.772-35.424,49.848v15.146
      h106.191v-15.146C106.271,466.397,91.421,446.921,70.839,439.625z" />
    <path d="M206.08,439.625c11.69-6.319,19.692-18.522,19.692-32.73c0-20.662-16.718-37.363-37.364-37.363
      ...
      h106.182v-15.146C241.511,466.397,226.678,446.921,206.08,439.625z" />
    <path d="M341.327,439.625c11.666-6.319,19.701-18.522,19.701-32.73c0-20.662-16.734-37.363-37.372-37.363
      ...
      h106.199v-15.146C376.751,466.397,361.902,446.921,341.327,439.625z" />
    <path d="M476.552,439.625c11.69-6.319,19.7-18.522,19.7-32.73c0-20.662-16.717-37.363-37.364-37.363
      ...
      v-15.146C512,466.397,497.15,446.921,476.552,439.625z" />
  </g>
</svg>
...
架空のキャラクター「IKKONDOさん」が舞台に登場・退場する演出アプリを制作しました。
お囃子や歓声、舞台の開閉演出などを組み合わせ、
...
<g>
	<path fill="#4B4B4B" d="M209.041,242.541c10.009-8.284,16.391-20.807,16.391-34.812c0-24.941-20.226-45.16-45.168-45.16
	...
	<path class="st0" d="M293.873,244.604c26.335-13.168,249.812-114.954,179.954-184.345
		c-71.012-70.528-187.61,139.605-201.897,166.794C258.85,251.921,267.538,257.772,293.873,244.604z" style="fill: rgb(75, 75, 75);"></path>
	<path class="st0" d="M487.872,253.613c-7.639-68.795-161.612-6.221-181.097,2.217c-17.834,7.72-15.69,14.642,4.198,18.978
		C330.869,279.143,495.383,321.288,487.872,253.613z" style="fill: rgb(75, 75, 75);"></path>
	<path class="st0" d="M329.233,100.938C343.134,46.543,344.585-3.258,301.036,0.167C223.925,6.235,242.629,156.614,253,214.844
		C263.927,194.819,293.727,143.092,329.233,100.938z" style="fill: rgb(75, 75, 75);"></path>
</g>
</svg>
                ...
                <div>
                  <p>
                    これは、昭和の名作CM「金鳥の夏、日本の夏」をオマージュして制作したオリジナル・パロディ作品です。 蚊取り線香やスプレーが活躍する中、雌鶏（めんどり）が走り出し、足跡を残しながら画面を駆け抜けていく── ユーモアとノスタルジーが混ざった、ひと夏のCM風アニメーションです。
                  </p>
                  <a
                    href="https://gincho-summer-cm.vercel.app/"
                    className="mt-3 text-green-500 items-center"
                  >
                    もっと見る→
                  </a>
